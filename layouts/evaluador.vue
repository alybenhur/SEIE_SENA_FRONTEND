<template>
  <div class="min-h-screen evaluador-bg relative overflow-hidden">
      ...
      <div class="relative z-10 w-full flex items-center justify-between px-6">
        ...
        <nav class="flex items-center gap-2">
          ...
          <NuxtLink to="/evaluador/mis-asignaciones"
            class="nav-pill"
            :class="$route.path.startsWith('/evaluador/mis-asignaciones') || $route.path.startsWith('/evaluador/evaluar') ? 'nav-pill-active' : 'nav-pill-idle'">
          ...
          <!-- Mi perfil -->
          <NuxtLink to="/evaluador/perfil"
            class="nav-pill"
            :class="$route.path === '/evaluador/perfil' ? 'nav-pill-active' : 'nav-pill-idle'">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
